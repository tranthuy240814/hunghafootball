...
<div class="container-fluid mt-4">
    <div class="card card-default">
        ...
        <div class="card-body">
            <form id="formAccountSettings" method="POST" action="{{ route('video.store') }}" enctype="multipart/form-data">
                @csrf()
                <div class="row">
                            ...
                            <div class="">
                                <div class="" style="display: inline-grid;">
                                    ...
                                    <div class=" choose-avatar">
                                        <div id="btnimage">
                                            <img id="showImage" class="show-avatar" src="{{asset( '/images/video.jpg')}}" alt="avatar">
                                        </div>
                                        <div id="button">
                    ...
                    <div class="col-md-6">
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <input class="form-control" value="{{ old('title') }}" type="text" name="title" id="name" placeholder="{{ __('Enter video title') }}"/>
                                @if ($errors->has('title'))
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <input class="form-control" value="{{ old('url') }}" type="text" name="url" id="name" placeholder="{{ __('Enter video url') }}"/>
                                @if ($errors->has('url'))
