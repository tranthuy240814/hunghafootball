...
@section('title')
    {{ env('APP_NAME', 'Badminton.io') }} - {{ __('Update Schedule') }}
@endsection
                ...
                <form id="formAccountSettings" method="POST" action="{{ route('schedule.update', $dataSchedule['id']) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="col-12">
                            ...
                            <input class="form-control" value="{{ $dataSchedule->match }}" type="text" name="match" id="match" placeholder="{{ __('Enter match ') }}"/>
                            @if ($errors->has('match'))
                    ...
                    <div class="col-md-6">
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <input class="form-control" value="{{ $dataSchedule->time }}" type="time" name="time" id="name" placeholder="{{ __('Enter time') }}"/>
                                @if ($errors->has('time'))
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <input class="form-control" value="{{ $dataSchedule->date }}" type="date" name="date" id="date" placeholder="{{ __('Enter date') }}"/>
                                @if ($errors->has('date'))
                    ...
                    <div class="col-md-6">
                        <div class="col-12">
                            ...
                            <input class="form-control" value="{{ $dataSchedule->stadium }}" type="text" name="stadium" id="stadium" placeholder="{{ __('Enter stadium') }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" value="FC Hưng Hà" type="text" name="team1" id="team1" placeholder="{{ __('Enter video title') }}"/>
                                        @if ($errors->has('team1'))
                        ...
                        <div class="col-md-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <div class="" style="display: inline-grid;">
                                        ...
                                        <div class=" choose-avatar">
                                            <div id="btnimage">
                                                <img id="showImage" class="show-avatar" src="{{asset( $dataSchedule->team2 ?? '/images/team_default.png' )}}" alt="avatar">
                                            </div>
                                            <div id="button">
                            ...
                            <div class="col-md-6">
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <label for="lastName" class="form-label">{{__('Team Name')}}</label>
                                        <input class="form-control" value="{{ $dataSchedule->team2 }}" type="text" name="team2" id="team2" placeholder="{{ __('Enter team2') }}"/>
                                        @if ($errors->has('team2'))
